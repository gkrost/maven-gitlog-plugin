...
public class AsciidocRenderer extends FileRenderer {
	...
	public AsciidocRenderer(Log log, File targetFolder, String filename, boolean fullGitMessage,
			MessageConverter messageConverter, String asciidocHeading, boolean isAsciidocTableView,
