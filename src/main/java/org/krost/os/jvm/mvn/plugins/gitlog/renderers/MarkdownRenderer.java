 ...
 *
 * The created markdown file will have - a h1 heading, - bold tags - and commits in each line.
 *
 * Markdown reference is http://daringfireball.net/projects/markdown/
 *
 * Output Example: # Maven GitLog Plugin changelog **maven-gitlog-plugin-1.4.11** 2012-03-17 07:33:55 +0100 Updated
 * maven version in docs (Daniel Flower) ...
 *
 */
public class MarkdownRenderer extends FileRenderer {
	...
	public MarkdownRenderer(Log log, File targetFolder, String filename, boolean fullGitMessage,
			MessageConverter messageConverter, boolean append) throws IOException {
	...
	/**
	 * Helper function to escape some important characters for the markdown hyperlink. A backslash will be added in
	 * front of [ and ]. At least these characters need to be escaped in markdown, else the markdown hyperlink will not
	 * work.
	 *
